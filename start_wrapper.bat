...
echo Vyond Legacy Offline v.1.2.1 beta
echo A project from Fanimation36
echo Adapted by Fanimation36 and Joseph Animate 2021!
echo Version v1.2.1
echo:
...
title Vyond Legacy Offline v1.2.1 BETA [Loading...]
...
title Vyond Legacy Offline v1.2.1 BETA
...
echo:
echo Vyond Legacy Offline v1.2.1 running
echo A project from VisualPlugin adapted by Benson and the Goanimate Team
echo:
